    ...
    public static class Districts
    {
        ...
        public static readonly DistrictDef[] All =
        {
            new DistrictDef
            {
                ...
                Wealth = 24,
                Palette = new[] { C("#8C93A3"), C("#A0A7B6"), C("#7C8494"), C("#B5654A"), C("#9A5C46") },
            ...
            new DistrictDef
            {
                ...
                Patience = 0.5f,
                Wealth = 30,
                Palette = new[] { C("#7A7266"), C("#8A8175"), C("#6E6659"), C("#94513B"), C("#7E6A54") },
                Storeys = new Vector2Int(1, 2),
            ...
            new DistrictDef
            {
                ...
                Patience = 0.55f,
                Wealth = 38,
                Palette = new[] { C("#C0A882"), C("#D2BC95"), C("#AE9770"), C("#B5654A"), C("#C99C6A") },
